...
<a href="../index.php" class="my-4 text-center"><h4>Regresar al menu</h4></a>
    <div class="container">
        <h2 class="pt-4">Cuántos no binarios no foráneos hay</h2>

        <table class="table table-striped mt-5">
            <thead>
                <tr>

                    <th>No binarios no foraneos</th>
            ...
            <tbody>
                <?php foreach ($countForeing as $count) : ?>
                    <tr>
                        <td><?= $count['No binarios, no foraneos']; ?></td>
                    </tr>
                <?php endforeach; ?>
